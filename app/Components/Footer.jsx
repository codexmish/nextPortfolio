...
const Footer = () => {
  return (
    <>
      <section
        id="footer"
        className="bg-[#121212] py-10 md:py-16 pt-20 md:pt-25"
      >
        {" "}
        ...
        <footer className="container mx-auto px-4 text-center">
          ...
          <div className="mb-8 md:mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-red-500 logo-text">
              LOGO
            </h3>{" "}
            {/* Red text for LOGO */}
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-8 md:mb-12 text-gray-400 text-lg md:text-xl">
            <div className="flex items-center gap-2">
              ...
              <span>dkhdkaxqybdik8@gmail.com</span>
            </div>
            <div className="flex items-center gap-2">
              <FaPhoneAlt className="text-xl" />
              <span>+8805675434</span>
            </div>
          </div>
          {/* Divider Line */}
